                    ...
                    <div class="card-body" style="box-shadow: 4px 3px #18814b, -6px 0 0.4em #0080145e">
                        ...
                        <div class="row">
                            <div class="col-md-1">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="invoice_no" type="text" value="{{$invoice_no}}"
                                        id="invoice_no" style="background-color: #ddd;" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-1">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control stock-quantity" name="stock" type="text" value=""
                                        id="stock" style="background-color: #bef2d6d6;" readonly>
                                </div>
                            ...
                            <div class="col-md-4" class="">
                                ...
                                <button class="btn btn-success btn-rounded  addeventmore" value="" style="color:#fff ;">
                                    Add more</button>
                        ...
                        <form action="{{route('storeinvoicedata')}}" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="calculate_amount" value="0" id="calculate_amount"
                                                class="form-control" readonly style="background-color:#bef2d6d6;">
                                        </td>
                            ...
                            <div class="">
                                <div class="form-group col-md-12">
                                    <textarea class="form-control" name="description" id="descrition"
                                        placeholder="You can write description"></textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9">
                                    ...
                                    <select name="customer_id" id="customer_id" class="customer_id form-select"
                                        required>
                            ...
                            <br>
                            <div class="col-md-3 ">
                                <input type="number" name="partial_amount" class="form-control partial_amount" value="1"
