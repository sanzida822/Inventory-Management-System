...
<div class="page-content">
   ...
   @endphp                     
        ...
        <a href="{{route('invoice.pending')}}" style="float:right" class="btn btn-dark btn-rounded waves-effect waves-light"><i class="fa fa-list"></i> Pending Invoice List</a>
                                     <br><br>
...
<table class="table">
  ...
  <tr>
      <th scope="col">#</th>
      <th scope="col"><p style="font-weight:600;">Customer Name: {{$payment['customer']['name']}}</p> </th>
      <th scope="col"><p style="font-weight:600;">Customer Moble: {{$payment['customer']['mobile_number']}}</p> </th>

      <th scope="col"><p style="font-weight:600;">Customer Gmail: {{$payment['customer']['email']}}</p> </th>
    </tr>
  </thead>
  <tbody>
  <tr >
