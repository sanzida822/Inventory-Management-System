                                                ...
                                                <tbody>
                                                    @foreach($alldata as $key=>$item)
                                                        ...
                                                        <td style="width: 100px">
                                                            ...
                                                            <a href="{{route('invoice.approve',$item->id)}}" id="" class="btn btn-dark sm" title="Approved
                                                            ">
                                                                <i class="fas fa-check-circle"></i>
                                                            </a>

                                                            
                                                            <a href="{{route('invoice.delete',$item->id)}}" id="approve" class="btn btn-danger sm" title="Delete
                                                            ">
