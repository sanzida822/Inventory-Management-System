                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Print Stock Table</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                          ...
                                          @php
                        $buying_qty=App\Models\Purchase::where('category_id',$data->category_id)->where('product_id',$data->id)->where('status','1')->sum('buying_qty');
                        $sellig_qty=App\Models\InvoiceDetail::where('category_id',$data->category_id)->where('product_id',$data->id)->where('status','1')->sum('selling_qty');
                    @endphp 
                                                ...
                                                <td class="text-center">{{$key+1}}</td>
                                                    ...
                                                    <td class="text-center">{{$sellig_qty}}</td>
