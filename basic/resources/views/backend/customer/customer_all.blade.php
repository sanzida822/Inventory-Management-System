                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
        <a href="{{route('customer.add')}}" style="float:right" class="btn btn-dark btn-rounded waves-effect waves-light">Add Customer</a>
                                     <br><br>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach($customer as $key=>$item)
                                                        ...
                                                        <td><img src="{{asset($item->customer_image)}}" style="width:60px;height:70px" alt=""></td>
