    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <a href="{{route('stock.report.print')}}" style="float:right" class="btn btn-dark btn-rounded waves-effect waves-light"><i class="fa fa-print"></i> Print Stock Report</a>
                    <br><br>
<h4 class="card-title">Stock Table</h4>
                    ...
                    @endphp  
                                    ...
                                    <td data-field="name" class="" class="text-center">{{$item['unit']['name']}}</td>
                                    <td data-field="" class="text-center"><span class="btn btn-success" >{{$buying_qty}} </span></td>
                                    <td data-field="" class="text-center"><span class="btn btn-success" >{{$sellig_qty}}</span> </td>
                
                                    <td data-field="" class="text-center"><span class="btn btn-danger">{{$item->quantity}}</td></span>
                                </tr>
                                @endforeach
