            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body" style="box-shadow: 4px 3px #18814b, -6px 0 0.4em #0080145e">
                        <a href="{{route('supplier.add')}}" style="float:right"
                            class="btn btn-success btn-rounded waves-effect waves-light">Add Supplier</a>
                        <br><br>
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="1" style="cursor: pointer;">
                                        ...
                                        <td style="width: 100px">
                                            ...
                                            <!-- <a href="{{route('supplier.delete',$item->id)}}" id="delete"
