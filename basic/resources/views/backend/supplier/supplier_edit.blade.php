        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" value="{{$supplier->name}}" class="form-control" type="text" required   id="oldpassword">
                </div>
            </div>
            ...
            <!-- end row -->
             ...
             <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                <input name="mobile"  value="{{$supplier->mobile_number}}" class="form-control" required type="text"  id="mobile">
                </div>
            </div>
            <!-- end row -->
             ...
             <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="email"  value="{{$supplier->email}}" class="form-control" required  type="email"   id="email">
                </div>
            </div>
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Supplier Address</label>
                <div class="form-group col-sm-10">
                    <input name="address"  value="{{$supplier->address}}"  class="form-control" type="text"   id="email" required>
                </div>
            </div>
            <!-- end row -->
