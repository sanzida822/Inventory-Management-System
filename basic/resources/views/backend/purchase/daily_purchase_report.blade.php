    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body"  style="box-shadow: 4px 3px #18814b, -6px 0 0.4em #0080145e">
                ...
                <h4 class="card-title">purchase Report </h4><br><br>
                <form action="{{route('dailypurchase.pdf')}}" target="_blank" method="get">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="sdate" name="startdate" type="date"  placeholder="YY-MM-DD">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="edate" name="enddate" type="date"  placeholder="YY-MM-DD">
                        </div>
                    ...
                    <br>
                        <button type="submit" required class=" btn btn-info" id="daily_purchase_search">Search</button>
                    </div>
