                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
        <a href="{{route('product.add')}}" style="float:right" class="btn btn-dark btn-rounded waves-effect waves-light">Add Product</a>
                                     <br><br>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach($product as $key=>$item)
                                                        ...
                                                        <td data-field="mobile">{{$item['supplier']['name']}}</td>
                                                        <td data-field="email">{{$item['unit']['name']}}</td>
                                                        
                                                        <td data-field="address">{{$item['unit']['name']}}</td>
