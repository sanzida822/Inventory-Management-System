  <header id="page-topbar" style="background-color:#194532 ;">
      <div class="navbar-header">
          <div class="d-flex">
              ...
              <div class="navbar-brand-box">
                  ...
                  <h4 style="color:#fff;margin-top:17px;font-weight:600">My Inventory</h4>
              </div>
              ...
              <div class="dropdown d-inline-block user-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="{{ route('edit.profile') }}"><i
                              class="ri-wallet-2-line align-middle me-1"></i> Profile</a>
                      ...
                      <a class="dropdown-item text-danger" href="{{ route('admin.logout') }}"
                          style="font-weight:600">Logout</a>
                  </div>
              </div>
