                        ...
                        <div class="card-body py-5">
                            <div class="row justify-content-center">
                                <div class="col-sm-6 d-flex align-items-center order-1 order-lg-2" style="    justify-content: space-around;">
                                    ...
                                    <img src="{{ asset('backend/assets/images/lo.png') }}" width="70%" height="auto" class=" img-fluid" alt="Sample image">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form action="{{ route('login') }}" method="post">
                                        ...
                                        <div class="d-flex flex-row align-items-center" style="margin-bottom: 22px;">
                                            <i class="fas fa-user fa-lg me-3 fa-fw" style="margin-right: 5px;"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input class="form-control" placeholder="Username" type="text" style="padding:10px;font-size:17px ;" name="username" autofocus required>
                                            </div>
                                        </div>
                                        <!-- <div class="d-flex flex-row align-items-center" style="margin-bottom: 22px;">
                                        ...
                                        <div class="d-flex flex-row align-items-center" style="margin-bottom: 10px;">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input class="form-control;font-size:17px" placeholder="Password" type="password" style="padding:10px" name="password" required>
                                        ...
                                        <div class="d-flex align-items-center" style="justify-content: space-between;margin-bottom:10px;    margin-left: 26px;">

                                            <a href="{{ route('password.request') }}" class="float-end ms-auto forgot">
                                                <small style="color:#993721;font-weight:600;font-size:15px">
                                                    forgot password?</small>
                                            </a>
                                        </div>
                                        <div class="d-flex justify-content-end  mb-3 mb-lg-4" style="">
                                            <button type="submit" name="login" class="btn-lg" style="background-color:#993721;color:white;font-weight:600;padding:8px 18px">Log In
                                                </button>
                                        </div>
                                    </form>
                                    <div class="d-flex justify-content-center  mb-3 mb-lg-4">
                                        <p><small style="font-size:14px;font-weight:550">No Account? </small></p>
                                        <a href="{{ route('register') }}"  style="text-decoration: none; padding-left:3px;"><small style="color:#993721;font-weight:600;font-size:14px"> Sign Up Here
                                            </small></a>
